  ...
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <section className="flex flex-col gap-3 rounded-xl border border-black/[.08] dark:border-white/[.145] p-4 w-full sm:w-auto">
          <h2 className="text-base/6 font-medium tracking-[-.01em]">
            Users → Posts
          </h2>
          <p className="text-sm/6 text-black/70 dark:text-white/70">
            Open the users list and navigate to user posts.
          </p>
          <Link
            href="/users"
